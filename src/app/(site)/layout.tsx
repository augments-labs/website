      ...
      >
        <div className="safe-x mx-auto flex w-full max-w-5xl items-center justify-between py-3">
          ...
          <div className="flex items-center gap-2.5 sm:gap-3">
            <Link
              href="/docs"
              className="inline-flex min-h-11 items-center rounded-lg bg-accent px-3 text-xs font-semibold text-[#06201d] transition-opacity hover:opacity-90 sm:min-h-9 sm:px-4 sm:text-sm"
            >
              Docs
            </Link>
            <a
              ...
              target="_blank"
              rel="noreferrer"
              aria-label="Augments Labs on GitHub"
